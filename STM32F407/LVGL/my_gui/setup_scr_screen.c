...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_btn_1, 18, 50);
    ...
    lv_label_set_text(ui->screen_label_1, "hallo world\n");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_1, 80, 13);
    lv_obj_set_size(ui->screen_label_1, 119, 37);
    ...
    lv_obj_set_pos(ui->screen_spinner_1, 89, 121);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 163, 50);
